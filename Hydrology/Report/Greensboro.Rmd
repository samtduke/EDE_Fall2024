...
These increasingly uneven trends become even more apparent when we give equal weight to pre-2000 and post-2000 data, filtering data to give a 16-year year window pre/post 2000.
...
ggplot(Greensboro_Seasonal_Averages_Modified, aes(x = year, y = avg_precip)) +
  geom_bar(stat = "identity", fill = "steelblue") +  # Bar plot for average precipitation
  geom_smooth(method = "lm", se = FALSE, color = "red") +  # Add linear regression line
  facet_wrap(~ Season) +  # Facet by season ("Hurricane Season" and "Frontal")
