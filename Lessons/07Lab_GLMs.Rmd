...
PM25byOzone.reg<-lm(data=EPAair, PM2.5 ~ Ozone)
summary(PM25byOzone.reg)
...
library(corrplot)
EPAairCor<- cor(EPAair.subset)
corrplot(EPAairCor, upper='ellipse')
...
OzoneAll.reg<- lm(EPAair, PM2.5 ~ Ozone + Year + Month + mean_Lng + mean_Lat)
