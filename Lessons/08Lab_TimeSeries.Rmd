...
BR_Rainfall_ts <- ts(BR_complete$Rainfall,
...
BR_Rainfall_Decomposed<-stl(BR_Rainfall_ts,
                            s.window = 'periodic')

plot(BR_Rainfall_Decomposed)

BR_Temperature_Decomposed<-stl(BR_Temperature_ts,
                            s.window = 'periodic')
...
BR_Temperature_Components <- as.data.frame(BR_Temperature_Decomposed$time.series[,1:3])
...
ggplot(BR_Rainfall_Components(aes(x=Observed, y=Date)))+
  geom_line()
