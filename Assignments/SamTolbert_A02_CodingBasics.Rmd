...
```{r basics 3}
#10. Create a function using if...else #Disclosure: asked R Wizard GPT for an example of if...else structure. The individual parts make sense but GPT helps with structure.
...
#11. Create a function using ifelse() #Disclosure: Consulted with R Wizard GPT to debug (I had parentheses issues). It also helped explain the uses of "return(result)" which it explains is a little extraneous but will help when the logic gets more complicated, so I am using it.
...
> Answer: ifelsse woerked because ifesle allows for vectorization. if...else will allow for one answer for one data, but ifelse will return results for an entire vector. 
